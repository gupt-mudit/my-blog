...
class ModelsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create model" do
    assert_difference("Model.count") do
      post models_url, params: { model: { categories: @model.categories, name: @model.name } }
    end
  ...
  test "should update model" do
    patch model_url(@model), params: { model: { categories: @model.categories, name: @model.name } }
